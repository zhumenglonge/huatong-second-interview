...
const messages = {
  zh: {
    ...
    newChat: '新建空白问答会话', project: '项目', hub: '中心', help: '帮助', account: '账号', mainNav: '主导航',
    ...
    notesPlaceholder: '在此记录这个任务的笔记…', notesNeedTask: '选择或创建一个任务后即可记录笔记', notesSaved: '已保存', notesSaving: '保存中…',
    notesEdit: '编辑', notesPreview: '预览', notesPreviewEmpty: '暂无内容，切换到编辑开始写笔记',
  ...
  en: {
    ...
    newChat: 'New chat', project: 'Projects', hub: 'Skills', help: 'Help', account: 'Account', mainNav: 'Main navigation',
    ...
    notesPlaceholder: 'Write notes for this task…', notesNeedTask: 'Select or create a task to take notes', notesSaved: 'Saved', notesSaving: 'Saving…',
    notesEdit: 'Edit', notesPreview: 'Preview', notesPreviewEmpty: 'Nothing yet — switch to edit to start writing',
